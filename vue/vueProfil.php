    ...
    <script src="loading.js"></script>
        ...
        if($critereRecherche == null){ ?>
            ...
            <div id="search-bar-medecin">
                ...
                <form action="./?action=rechercheRapport" method="post">
                ...
                <table id="rapport-table">
                    ...
                    <tbody>
                        ...
                        for ( $i=0 ; $i<count($lesRapportVisiteur) ; $i++){ 
                            ...
                            /* Boucle pour récupérer tout les médicaments avec sa quantité associée du rapport d'indice i */
                            ...
                            <tr>
                                ...
                                <td> <!-- Case du tableau de la quantité de médicaments offerte -->
                                    ...
                                    if ($_GET['id'] == null){ ?>
                                        <a href="./?action=modificationRapport&id=<?php echo $lesRapportVisiteur[$i]->get_IdRapport(); ?>" id="rapport-modify-btn"> <i class='bx bxs-edit' ></i></a> <?php
                                    } ?>
                                </td>
